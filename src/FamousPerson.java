...
public class FamousPerson implements Comparable<FamousPerson>
{
  ...
  // additional methods
	...
	/**
	 * Comparator method that sorts by first name, then by last name
	 * @return Comparator<FamousPerson>
	 */
	...
	/**
	 * Comparator method that sorts by year of birth in descending order
	 * @return Comparator<FamousPerson>
	 */
public static Comparator<FamousPerson> yearOfBirthComparatorDecreasing()
{
	return new Comparator<FamousPerson>()
	{
		@Override
	...
	/**
	 * Comparator method that sorts by length of fact
	 * @return Comparator<FamousPerson>
	 */
public static Comparator<FamousPerson> factComparator()
{
	return new Comparator<FamousPerson>()
	{
		...
		public int compare(FamousPerson o1, FamousPerson o2)
		{
			return o1.getFact().length() - o2.getFact().length();
		}
	};
}
